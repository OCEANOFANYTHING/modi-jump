...
const playingObject = {
  ...
  drewPlayObject() {
    ...
    canvasTx.drawImage(
      ...
      -this.imgAnimation[this.frames].playObjectImg.width * this.scale / 2,
      -this.imgAnimation[this.frames].playObjectImg.height * this.scale / 2,
      this.imgAnimation[this.frames].playObjectImg.width * this.scale,
      this.imgAnimation[this.frames].playObjectImg.height * this.scale
    );
    canvasTx.restore();
  },
  updateFrames() {
  ...
  collisioned() {
    ...
    let y = pipe.pipe[0].y;
    let bridPro =
      parseFloat(this.imgAnimation[0].playObjectImg.width * this.scale) / 4 +
      parseFloat(this.imgAnimation[0].playObjectImg.width * this.scale) / 4;
